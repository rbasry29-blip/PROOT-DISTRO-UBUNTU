...
proot-distro login ubuntu -- bash -c "apt install elementery-xfce-icon-theme-y && dpkg --configure -a && apt update -y && apt install xubuntu-desktop dbus-x11 -y && printf '${b}[${g}*${b}]${g} Adding user ubuntu ${r}\n' && adduser --disabled-password --gecos '' ubuntu"
